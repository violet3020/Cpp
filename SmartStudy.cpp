...
/*if(user_answer==correct_ans){     This was the former piece of code to compare the user answer and the correct answer
    cout<<"EUREKA, You've done it. Great job"<<endl;
}
else if(user_answer!=correct_ans){
    cout<<"Oh no, that is the wrong answer"<<endl;
    cout<<"The correct answer is : "<<correct_ans<<endl;
}*/
...
MyFile.open("/Users/talentyolandandlovu/Documents/Cpp projects/test.txt", ios::app);
...
cin>>user_response;
ifstream MyReadFile;
MyReadFile.open("/Users/talentyolandandlovu/Documents/Cpp projects/test.txt");
if (user_response=='Y'){
